...
/**
 * Servlet implementation class DelGBoardCommentServlet
 */
@WebServlet(name = "DelGBoardComment", urlPatterns = { "/delGBoardComment" })
public class DelGBoardCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DelGBoardCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = gbs.deleteBoardCmt(cmtNo);
		if(result > 0) {
