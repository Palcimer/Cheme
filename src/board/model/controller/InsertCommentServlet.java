...
public class InsertCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//1.인코딩
				...
				bc.setCommentContent(request.getParameter("bcContent"));
				bc.setLevel(Integer.parseInt(request.getParameter("bcLevel")));
				bc.setBcRef(Integer.parseInt(request.getParameter("bcRef")));
				bc.setCommentWriter(request.getParameter("bcWriter"));
				...
				request.setAttribute("loc", "/boardView?boardNo="+bc.getBoardRef());
